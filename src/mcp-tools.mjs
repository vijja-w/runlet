export const mcpToolGroups = [
  ...
  },
  {
    ...
    tools: [
      ...
      ['read_file', 'Read a text or binary file inside a registered workspace as UTF-8 or base64.'],
      ['write_file', 'Create or replace a text or binary file inside a registered workspace using UTF-8 or base64. Missing parent folders are created.'],
  ...
  },
  {
    ...
    tools: [
      ...
      ['get_app_template', 'Get the authoritative portable App structure and rules. Call before creating or substantially editing App files.'],
      ['run_app', 'Run an App and return its logs. Read its declared output files before reporting completion.'],
  ...
  },
  {
    ...
    tools: [
      ...
      ['get_prompt_template', 'Get the authoritative Prompt structure and authoring rules. Call before creating or substantially editing Prompt files.'],
    ],
  },
];
